...
const NotFound: React.FC = (): JSX.Element => {
  ...
  return (
    <div className="px-2 sm:px-0 flex flex-col h-[100vh] w-full items-center justify-center space-y-6 select-none text-center absolute left-0 top-0 z-50 bg-black">
